> **Note:** This is a fork of [`LmeSzinc/AzurLaneAutoScript`](https://github.com/LmeSzinc/AzurLaneAutoScript), primarily focused on optimizations for Operation Siren's extreme corrosion level 1.
>
> **注意：** 本仓库是 [`LmeSzinc/AzurLaneAutoScript`](https://github.com/LmeSzinc/AzurLaneAutoScript) 的一个 Fork 分支，主要为优化“大世界-极致侵蚀1”的相关功能。
>
> ---

## 优化的核心理念以及解释 (Core Philosophy of Optimization and Explain)

首先，我个人认为，自动化脚本是帮助时间有限的玩家更好地体验游戏的工具。对此，我遵循并提倡一个简单的原则：低调使用，互相尊重。请在个人范围内安静地享受便利，避免在公开场合“跳脸”或宣扬，共同维护我们都身处其中的和谐社区环境。

---

**原版 Alas 与本分支的定位差异**

必须明确的是，原版 Alas 对于绝大多数玩家而言，已是功能完善且强大的最优选择。无论是轻度、中度还是重度“肝”度的玩家，在没有极限追求指挥官经验或每日游戏时间有限（低于15小时）的情况下，使用原版 Alas 都能获得绝大部分游戏资源，是当前的最优策略。

许多人以为原版设置诸多上限单纯是限制用户的行为，实际上这是对游戏理解不够的想法。原版的逻辑是通过极少量的大世界时间即可获取绝大多数的资源，从而可以快速进入另一个行为————低耗，从而获取大量更多的资源，如物资，魔方乃至红尖尖

本分支 (fork) 的核心目标则专注于一个更为极限的特定玩法：以最大化指挥官经验为目的，通过“极致侵蚀1”的资源循环策略获取收益。

极致侵蚀1的原理是几乎无损的使用黄币兑换行动力，再使用行动力兑换黄币，从而实现半永动。因为黄币是有限的，所以任何花销黄币的行为都是禁止的，直到月末才能花销。

为实现这一目标，本分支的逻辑进行了针对性调整————暴力移动舰队并二次检查防止漏猫，踩塞壬探测装置花费2紫币破坏后获取黄币，取消10万黄币硬下限并改为2万，3000行动力硬上限，自动短猫。

---

**使用前置条件与须知**

鉴于本分支的特化定位和高强度的玩法策略，在使用前，请您务必确认满足以下所有条件：

- 明确的目标：您当前的核心需求是最大化获取指挥官经验。

- 深刻的游戏理解：您对大世界，特别是资源循环机制有深刻的理解（防止缺黄币等）

- 高练度的舰队：您拥有至少达到准顶配的侵蚀等级5和等级1的速刷舰队。

- 手动操作的意愿：您愿意接受并手动完成短猫，宝箱等任务。

- 风险承担：由于本人水平有限，本分支可能存在未知的bug，您需要能够接受并处理这些潜在问题。

如果您不满足以上任一条件，建议您继续使用原版 Alas，以获得更稳定、普适的游戏体验。
...
- **[优化]** 删除侵蚀一对塞壬探测装置等限制，
- **[新增]** 增加遇到事件结束后，暴力移动舰队并搜索两次是否有遗漏行动力
